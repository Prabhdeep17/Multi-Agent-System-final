...
def writer_agent(state: PolicyState) -> PolicyState:
    ...
    messages = [
        SystemMessage(content=(
            ...
            "- NO CROSS-DOCUMENT WEAVING: Never combine disjointed terms from different documents into a single sentence to make it sound cohesive.\n\n"
            "## FORMAT RULES:\n"
...
def reviewer_agent(state: PolicyState) -> PolicyState:
    ...
    messages = [
        SystemMessage(content=(
            ...
            "Verify the Writer did not weave disjointed facts from separate documents into a single 'cohesive' sentence (e.g. 'Baseline metrics further support the stability...'). If the Writer added a summary, concluding sentence, or narrative bridge at the end of a paragraph, you MUST delete that sentence entirely.\n\n"
